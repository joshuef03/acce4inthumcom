...
function openModal(e) {
  ...
  const modalImage = document.querySelector(".modal-project-image img");

  // Get the source of the clicked project image
  const projectImageSource = e.target.style.backgroundImage.slice(5, -2);

  // Update the modal image source
  modalImage.src = projectImageSource;
